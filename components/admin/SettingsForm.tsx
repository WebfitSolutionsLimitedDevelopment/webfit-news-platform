...
export default function SettingsForm({initial}:Props){
  ...
  async function submit(e:React.FormEvent<HTMLFormElement>){
    ...
    const payload={
      ...
      social:{facebook:fd.get('facebook'),instagram:fd.get('instagram'),youtube:fd.get('youtube'),linkedin:fd.get('linkedin'),x:fd.get('x'),tiktok:fd.get('tiktok')}
    };
