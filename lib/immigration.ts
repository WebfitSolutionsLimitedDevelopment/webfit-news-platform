...
export const visaDefinitions: VisaDefinition[] = [
  ...
  { slug: 'trafficking-victim-work-visa', name: 'Trafficking Victim Work Visa', category: 'Work', officialUrl: 'https://www.immigration.govt.nz/visas/trafficking-victim-work-visa/', summary: 'For people in New Zealand who have been certified by New Zealand Police as suspected victims of people trafficking.', keyQuestions: ['Who can apply?', 'How long can I stay?', 'What work can I do?', 'Can I study?', 'Can this lead to residence?'] },
  ...
  { slug: 'refugee-claimant-visitor-visa', name: 'Refugee Claimant Visitor Visa', category: 'Visit', officialUrl: 'https://www.immigration.govt.nz/visas/refugee-claimant-visitor-visa/', summary: 'For people in New Zealand who have made a refugee or protection claim and need to remain while the claim is decided.', keyQuestions: ['Who can apply?', 'How long can I stay?', 'What support can I access?', 'Can family be included?', 'What happens while my claim is processed?'] },
  ...
  { slug: 'partner-of-a-new-zealander-resident-visa', name: 'Partner of a New Zealander Resident Visa', category: 'Family', officialUrl: 'https://www.immigration.govt.nz/visas/partner-of-a-new-zealander-resident-visa/', summary: 'For eligible partners of New Zealand citizens or residents who want to live in New Zealand permanently.', keyQuestions: ['Who can apply?', 'How long must we have lived together?', 'What relationship evidence is required?', 'Can children be included?', 'When can I apply for permanent residence?'] },
  { slug: 'dependent-child-resident-visa', name: 'Dependent Child Resident Visa', category: 'Family', officialUrl: 'https://www.immigration.govt.nz/visas/dependent-child-resident-visa/', summary: 'For eligible dependent children aged 24 or younger joining a New Zealand citizen or resident parent.', keyQuestions: ['Who can apply?', 'What age rules apply?', 'What financial dependency rules apply?', 'Can the child work or study?', 'What evidence is required?'] },
  { slug: 'intercountry-adoption-resident-visa', name: 'Intercountry Adoption Resident Visa', category: 'Family', officialUrl: 'https://www.immigration.govt.nz/visas/intercountry-adoption-resident-visa/', summary: 'For eligible adopted children coming to live permanently with a New Zealand citizen or resident parent.', keyQuestions: ['Who can apply?', 'What adoption evidence is required?', 'Which adoptions qualify?', 'How long can the child stay?', 'What health and character rules apply?'] },
  { slug: 'parent-retirement-resident-visa', name: 'Parent Retirement Resident Visa', category: 'Family', officialUrl: 'https://www.immigration.govt.nz/visas/parent-retirement-resident-visa/', summary: 'For eligible parents with an adult child in New Zealand who meet the required investment, settlement-funds and income thresholds.', keyQuestions: ['Who can apply?', 'How much must I invest?', 'What annual income is required?', 'Can my partner be included?', 'When can I apply for permanent residence?'] },
  ...
  { slug: 'employees-of-relocating-business-resident-visa', name: 'Employees of Relocating Business Resident Visa', category: 'Residence', officialUrl: 'https://www.immigration.govt.nz/visas/employees-of-relocating-business-resident-visa/', summary: 'For key employees of qualifying businesses relocating to New Zealand who are not eligible for another resident visa.', keyQuestions: ['Who can apply?', 'What makes an employee integral?', 'What must the relocating business provide?', 'How long must I work for the business?', 'Can family be included?'] },
  { slug: 'entrepreneur-resident-visa', name: 'Entrepreneur Resident Visa', category: 'Residence', officialUrl: 'https://www.immigration.govt.nz/visas/entrepreneur-resident-visa/', summary: 'For eligible people who have successfully operated a self-employed business in New Zealand and meet the residence requirements.', keyQuestions: ['Who can apply?', 'How long must I have run the business?', 'What investment may be required?', 'What business performance is required?', 'Can family be included?'] },
  { slug: 'global-impact-permanent-resident-visa', name: 'Global Impact Permanent Residence Visa', category: 'Residence', officialUrl: 'https://www.immigration.govt.nz/visas/global-impact-permanent-resident-visa/', summary: 'For eligible Global Impact Work Visa holders who have held that visa for at least 30 months and retain qualifying fellowship support.', keyQuestions: ['Who can apply?', 'How long must I hold the work visa?', 'What fellowship support is required?', 'Can family be included?', 'What permanent residence rights apply?'] },
  { slug: 'community-sponsored-refugee-resident-visa', name: 'Community Sponsored Refugee Resident Visa', category: 'Residence', officialUrl: 'https://www.immigration.govt.nz/visas/community-sponsored-refugee-resident-visa/', summary: 'For eligible refugees nominated or matched with an approved community organisation under the Community Organisation Refugee Sponsorship Programme.', keyQuestions: ['Who can apply?', 'What nomination or referral is required?', 'Who sponsors settlement?', 'Can family be included?', 'What invitation process applies?'] },
  { slug: 'refugee-family-support-resident-visa', name: 'Refugee Family Support Resident Visa', category: 'Residence', officialUrl: 'https://www.immigration.govt.nz/visas/refugee-family-support-resident-visa/', summary: 'For eligible family members sponsored by a New Zealand citizen or resident who came to New Zealand as a refugee or protected person.', keyQuestions: ['Who can apply?', 'Who can sponsor?', 'How does sponsor registration work?', 'Can family be included?', 'What invitation process applies?'] },
  { slug: 'trafficking-victim-resident-visa', name: 'Trafficking Victim Resident Visa', category: 'Residence', officialUrl: 'https://www.immigration.govt.nz/visas/trafficking-victim-resident-visa/', summary: 'For eligible people in New Zealand who already hold a trafficking victim temporary visa and cannot safely return home.', keyQuestions: ['Who can apply?', 'What police certification is required?', 'What evidence about returning home is required?', 'How long can I stay?', 'What rights does residence provide?'] },
  { slug: 'victims-of-family-violence-resident-visa', name: 'Victims of Family Violence Resident Visa', category: 'Residence', officialUrl: 'https://www.immigration.govt.nz/visas/victims-of-family-violence-resident-visa/', summary: 'For eligible people whose partnership with a New Zealand citizen or resident has ended because of family violence and who cannot return home.', keyQuestions: ['Who can apply?', 'What evidence of family violence is required?', 'What relationship requirements apply?', 'Can children be included?', 'How long can I stay?'] },
];
