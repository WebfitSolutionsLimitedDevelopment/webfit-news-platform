...
const popularTools = [
  ...
  { href: '/ilikemypdf/jpg-to-pdf', title: 'JPG to PDF', text: 'Turn JPG images into a PDF document.' },
  { href: '/ilikemypdf/png-to-pdf', title: 'PNG to PDF', text: 'Combine one or more PNG images into a PDF.' },
  ...
  { href: '/ilikemypdf/word-to-jpg', title: 'Word to JPG', text: 'Turn readable Word document content into JPG output.' },
  { href: '/ilikemypdf/pdf-to-text', title: 'PDF to Text', text: 'Extract readable text from a text-based PDF.' },
  { href: '/ilikemypdf/text-to-pdf', title: 'Text to PDF', text: 'Turn pasted plain text into a simple PDF document.' },
  ...
  { href: '/ilikemypdf/remove-pdf-pages', title: 'Remove PDF Pages', text: 'Delete unwanted pages and download a new PDF.' },
  { href: '/ilikemypdf/organize-pdf-pages', title: 'Organize PDF Pages', text: 'Reorder PDF pages into the sequence you need.' },
  { href: '/ilikemypdf/add-page-numbers-to-pdf', title: 'Add Page Numbers', text: 'Add page numbers to PDF pages for easier reference.' },
